      ...
      <Section spacing="default">
        <div className="flex flex-col gap-12 lg:flex-row lg:justify-between">
          <div className="max-w-xs">
            ...
            {/* Animated Social Media Icons with Official Result Seekers Brand Colors */}
            <div className="mt-6">
                  ...
                  return (
                    <li key={social.id}>
                      <motion.a
                        ...
                        title={social.label}
                        className="relative flex h-10 w-10 items-center justify-center rounded-xl bg-background border border-border text-muted-foreground transition-all duration-300 shadow-xs cursor-pointer"
                        whileHover={{
                          scale: 1.15,
                          y: -3,
                          backgroundColor: "#4214c4", // Result Seekers Brand Purple
                          borderColor: "#f7941d",    // Result Seekers Brand Orange
                          color: "#ffffff",
                          boxShadow: "0 10px 25px -4px rgba(66, 20, 196, 0.35)",
                        }}
                        whileTap={{ scale: 0.95 }}
